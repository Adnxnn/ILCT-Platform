...
import { TextField, Button, Container, Box, Typography, CircularProgress, Card, CardContent, useTheme, IconButton } from '@mui/material';
                        ...
                        >
                            <CardContent sx={{ p: 3 }}>
                                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                    ...
                                    <Box sx={{ mt: 1 }}>
                                        <Typography variant="body2" color="rgba(255, 255, 255, 0.7)" align="center" sx={{ fontSize: '0.8rem' }}>
                                            Need test accounts? Try these:
                                        </Typography>
